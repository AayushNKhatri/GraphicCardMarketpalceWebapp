...
<section id="hero">
    ...
    <a href="<%=contextPath + StringUtills.DISPALY_PRODUCT%>"><button>SHOP NOW</button></a>
</section>
<section id="product1" class="section-p1">
    ...
    <div class="pro-container">
        <div class="pro">
            <img src="JSP/RTX-4070-SUPER-Back.png" alt="pro1">
            <div class="desc">
        ...
        <div class="pro">
            <img src="JSP/intel-arc-a40-pro-002.png" alt="pro1">
            <div class="desc">
        ...
        <div class="pro">
            <img src="JSP/AMD Radeon RX 6800 XT.png" alt="pro1">
            <div class="desc">
